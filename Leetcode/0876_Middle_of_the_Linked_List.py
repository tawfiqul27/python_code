...
# (The judge's serialization of this node is [3,4,5]). Note that we returned a ListNode object ans, such that: ans.val = 3, ans.next.val = 4,
...
#     nodes[depth] = head.val   # add the last node to dic

#     return nodes[(depth//2) + 1] if depth%2 else nodes[(depth/2) + 1]
